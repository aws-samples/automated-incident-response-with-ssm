...
#              with CIDRv4 0.0.0.0/0 and CIDRv6 ::/0
#
...
def lambda_handler(event, context):
    ...
    logger.info('Compliance evaluation for %s: %s' % (configuration_item['resourceId'], evaluation["compliance_type"]))
    logger.info('Annotation: %s' % (evaluation["annotation"]))
